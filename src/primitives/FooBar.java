...
public class FooBar {
    public static void main(String[] args) {
        ...
        // Если убрать блок else, инициализация будет неполной и возникнет ошибка компиляции
        if (myBoolean) {
            p = 1;
        } else {
            p = 2;
        ...
        // Если в условии будут варианты, когда инициализация не происходит, например: p > 2,
        // инициализация будет неполной и возникнет ошибка компиляции
        if (true) {
            q = 1;
        }
        ...
        // full initialization check
        //без default возникнет ошибка инициализации
        ...
        //Если условие не покрывает весь пул вариантов, возникнет ошибка компиляции
